...
* Relatório do volume atual das lixeiras;
* Relatório das lixeiras disponíveis para descarte que informe;
* Relatório quantidade de lixeiras que atingiram nível igual ou superior a 70% da capacidade máxima;
* Relatório da quantidade de manutenções das lixeiras, informando quantas vezes teve problemas;
* Relatório da situação operante das lixeiras (operante ou inoperante)
...
![9.9A2](https://github.com/coletaInt/trab01/blob/master/images/9.9A2.png)
